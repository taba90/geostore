...
public abstract class GeoStoreRemoteTokenService extends RemoteTokenServices {

    protected static Logger LOGGER =
            Logger.getLogger(GeoStoreRemoteTokenService.class);
    ...
    protected GeoStoreRemoteTokenService() {
        // constructor for subclasses that want to configure everything
    }

    protected GeoStoreRemoteTokenService(AccessTokenConverter tokenConverter) {
