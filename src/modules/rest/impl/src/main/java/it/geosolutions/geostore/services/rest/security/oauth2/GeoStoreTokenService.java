...
public class GeoStoreTokenService extends RemoteTokenServices {

        protected static Logger LOGGER =
                LoggerFactory.getLogger(GeoStoreTokenService.class);
        ...
        protected GeoStoreTokenService() {
            // constructor for subclasses that want to configure everything
        }

        protected GeoStoreTokenService(AccessTokenConverter tokenConverter) {
