...
public class OAuthLoginRestTest {
    ...
    public void testLogin(){
        ...
        TestingOAuthLoginRest testingOAuthLoginRest=new TestingOAuthLoginRest();
        ...
        testingOAuthLoginRest.setConfiguration(configuration);
        testingOAuthLoginRest.login("mock");
        assertEquals(302,response.getStatus());
        assertEquals("http://localhost:8080/authorization?response_type=code&client_id=mockClientId&scope=openid&redirect_uri=null&access_type=offline",response.getRedirectedUrl());
    }
    ...
    public void testCallback(){
        ...
        testingOAuthLoginRest.setConfiguration(configuration);
        Response response=testingOAuthLoginRest.callback("mock");
        assertEquals(302,response.getStatus());
